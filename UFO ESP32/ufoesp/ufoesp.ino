#define BLYNK_TEMPLATE_ID "TMPL-nscauRH"
...
#define VIRTUAL_PIN_POWER V0
#define VIRTUAL_PIN_RAISE_COW V1
...
//as soon as we connect  find out the last state
BLYNK_CONNECTED() {
  // Blynk.syncVirtual(VIRTUAL_PIN_ANIMATION_PICKER);  // will cause BLYNK_WRITE(VIRTUAL_PIN_ANIMATION_PICKER) to be executed
  Blynk.syncAll();
}

BLYNK_WRITE(VIRTUAL_PIN_COLOR_PICKER_G) {
  String val = String(param.asInt());
  G = param.asInt();

  Serial.println("COLOR PICKER G: " + val);
}
